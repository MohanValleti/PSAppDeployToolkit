...
if (test-path -PathType Leaf -$file_to_checksum) {
    $current_checksum = get-checksum -file $file_to_checksum -Algorithm $Algorithm
}

if ($expected_checksum -eq $current_checksum) {
